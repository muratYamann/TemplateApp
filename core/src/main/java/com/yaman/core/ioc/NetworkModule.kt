...
import com.yaman.core.constants.Constants.HEADER_UUID
import com.yaman.core.utils.UUIDManager
...
class NetworkModule {
    ...
    fun providesRetrofit(gsonConverterFactory: GsonConverterFactory,
        ...
        return Retrofit.Builder().baseUrl("https://www.kiehls.com.tr/")
    ...
    fun providesInterceptor(context: Context): Interceptor {
        return Interceptor { chain ->
            ...
            request = original.newBuilder()
                    ...
                    .header(HEADER_UUID, getAndroidUUID(context))
    ...
    private fun getAndroidUUID(context: Context): String {
        return UUIDManager.getInstance().getDeviceSecureId(context)
    }
